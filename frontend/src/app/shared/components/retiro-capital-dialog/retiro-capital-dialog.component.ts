...
@Component({
  ...
  templateUrl: './retiro-capital-dialog.component.html',
  styleUrls: ['./retiro-capital-dialog.component.css'],
})
export class RetiroCapitalDialogComponent {
  private fb = inject(FormBuilder);
  private dialogRef = inject(MatDialogRef<RetiroCapitalDialogComponent>);
